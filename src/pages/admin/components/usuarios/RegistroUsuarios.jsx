...
import { validatePassword, PASSWORD_REQUIREMENTS_TEXT } from "../../../../utils/passwordValidator";
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            try {
                ...
                const errorMsg = error.response?.data?.error || "Error al guardar el usuario";
                alert(errorMsg);
            }
        } else {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="form-control w-full">
                    <label className="label">
                        <span className="label-text font-semibold text-negro">Nombre Completo *</span>
                    </label>
                    <input
                        type="text"
                        name="nombre"
                ...
                <div className="form-control w-full">
                    <label className="label">
                        <span className="label-text font-semibold text-negro">Correo Electrónico *</span>
                    </label>
                    <input
                        type="email"
                        name="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="form-control w-full relative">
                        ...
                        {errors.password && touched.password ? (
                            <label className="label">
                                <span className="label-text-alt text-red">{errors.password}</span>
                            </label>
                        ) : (
                            <label className="label">
                    ...
                    <div className="form-control w-full">
                        <label className="label">
                            <span className="label-text font-semibold text-negro">Repetir Contraseña</span>
                        </label>
                        <div className="relative">
                            <input
                        ...
                        {errors.confirmPassword && touched.confirmPassword && (
                            <label className="label">
                                <span className="label-text-alt text-red">{errors.confirmPassword}</span>
                            </label>
                        )}
                    </div>
                </div>
                ...
                <div className="form-control w-full">
                    <label className="label">
                        <span className="label-text font-semibold text-negro">Rol de Usuario *</span>
                    </label>
                    <select
                        name="rol"
                        value={formData.rol}
                ...
                <div className="flex gap-4 pt-4">
                    ...
                    <button
                        type="button"
                        onClick={onCancel || (() => setFormData({ ...formData, nombre: "", email: "", password: "", confirmPassword: "" }))}
